...
<div class="container mx-auto px-4 py-10">
    ...
    <form action="{{ route('admin.landing.update') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2">Judul:</label>
            <input type="text" name="title" value="{{ $landingPage->title }}" class="w-full p-2 border border-gray-300 rounded-lg">
        </div>
