...
<nav x-data="{ menuOpen: false, show: false, lastScroll: 0 }"
    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-4">
            <a href="/" class="{{ request()->is('/') ? 'active' : 'text-white hover:underline' }}">Beranda</a>
            <a href="/profile" class="{{ request()->is('profile') ? 'active' : 'text-white hover:underline' }}">Profile</a>
            <a href="/informasi" class="{{ request()->is('informasi') ? 'active' : 'text-white hover:underline' }}">Informasi</a>
            <a href="/galeri" class="{{ request()->is('galeri') ? 'active' : 'text-white hover:underline' }}">Galeri</a>
